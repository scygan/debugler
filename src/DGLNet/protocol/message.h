...
class BreakedCall : public Message {
   ...
   public:
    ...
    BreakedCall(CalledEntryPoint entryp, value_t traceSize,
                opaque_id_t currentCtx, std::vector<ContextReport> ctxReports)
            : m_entryp(entryp),
