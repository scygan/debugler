...
static void blitFunc(const int* outputOffsets, int width, int height,
    ...
    for (int y = 0; y < height; y++) {
        ...
        for (int x = 0; x < width; x++) {
            ...
            if ((out = outputOffsets[0]) >= 0)
                dstPtr[out] = static_cast<unsigned char>(
...
GLDataType g_DataTypes[] = {
    {GL_UNSIGNED_BYTE,               1,                         false,
     blt::blitFunc<blt::blitUNORM8>, extract::extract<uint8_t>, 0},
    {GL_BYTE,                        1,                        false,
     blt::blitFunc<blt::blitSNORM8>, extract::extract<int8_t>, 0},
    {GL_UNSIGNED_SHORT,               2,                          false,
     blt::blitFunc<blt::blitUNORM16>, extract::extract<uint16_t>, 0},
    {GL_SHORT,                        2,                         false,
     blt::blitFunc<blt::blitSNORM16>, extract::extract<int16_t>, 0},
    {GL_UNSIGNED_INT,                 4,                          false,
     blt::blitFunc<blt::blitUNORM32>, extract::extract<uint32_t>, 0},
    {GL_INT,                          4,                         false,
     blt::blitFunc<blt::blitSNORM32>, extract::extract<int32_t>, 0},
    {GL_FLOAT,                        4,                       false,
     blt::blitFunc<blt::blitFLOAT32>, extract::extract<float>, 0},
    {GL_UNSIGNED_SHORT_4_4_4_4,         2,                         true,
     blt::blitFunc<blt::blitUNORM4444>, extract::extractUNORM4444, 4},
    {GL_UNSIGNED_SHORT_5_5_5_1,         2,                         true,
     blt::blitFunc<blt::blitUNORM5551>, extract::extractUNORM5551, 4},
    {GL_UNSIGNED_INT_2_10_10_10_REV,   4,
     true,                             blt::blitFunc<blt::blitUNORM2101010_REV>,
     extract::extractUNORM2101010_REV, 4},
    {GL_UNSIGNED_SHORT_5_6_5,          2,                        true,
     blt::blitFunc<blt::blitUNORM565>, extract::extractUNORM565, 3},
    {GL_UNSIGNED_INT_24_8,              4,                         true,
     blt::blitFunc<blt::blitUNORM24_8>, extract::extractUNORM24_8, 2},
    {GL_FLOAT_32_UNSIGNED_INT_24_8_REV,     8,                             true,
     blt::blitFunc<blt::blitF32_UNORM24_8>, extract::extractF32_UNORM24_8, 2},
    {GL_UNSIGNED_BYTE_3_3_2,           1,                        true,
     blt::blitFunc<blt::blitUNORM332>, extract::extractUNORM332, 2}, };

GLDataFormat g_DataFormats[] = {
    {GL_RED, 1},           {GL_RG, 2},              {GL_RGB, 3},
    {GL_RGBA, 4},          {GL_RED_INTEGER, 1},     {GL_RG_INTEGER, 2},
    {GL_RGB_INTEGER, 3},   {GL_RGBA_INTEGER, 4},    {GL_DEPTH_COMPONENT, 1},
    {GL_STENCIL_INDEX, 1}, {GL_DEPTH_STENCIL, 2},   {GL_ALPHA, 1},
    {GL_LUMINANCE, 1},     {GL_LUMINANCE_ALPHA, 2}, };
...
struct GLInternalFormat g_InternalFormats[] = {
    ...
    //},
    {GL_RGBA32F, GL_RGBA, GL_FLOAT}, {GL_RGBA16F, GL_RGBA, GL_FLOAT},
    ...
    //},
    {GL_RGB8, GL_RGB, GL_UNSIGNED_BYTE}, {GL_SRGB8, GL_RGB, GL_UNSIGNED_BYTE},
    ...
    //},
    {GL_RGB32F, GL_RGB, GL_FLOAT}, {GL_RGB16F, GL_RGB, GL_FLOAT},
    {GL_R11F_G11F_B10F, GL_RGB, GL_FLOAT}, {GL_RGB9_E5, GL_RGB, GL_FLOAT},
    {GL_RGB8UI, GL_RGB_INTEGER, GL_UNSIGNED_BYTE},
    {GL_RGB8I, GL_RGB_INTEGER, GL_BYTE},
    {GL_RGB16UI, GL_RGB_INTEGER, GL_UNSIGNED_SHORT},
    {GL_RGB16I, GL_RGB_INTEGER, GL_SHORT},
    {GL_RGB32UI, GL_RGB_INTEGER, GL_UNSIGNED_INT},
    {GL_RGB32I, GL_RGB_INTEGER, GL_INT}, {GL_RG8, GL_RG, GL_UNSIGNED_BYTE},
    {GL_RG8_SNORM, GL_RG, GL_BYTE},
    // We use GL_FLOATS for this one
    //{ GL_RG16F,          GL_RG,          GL_HALF_FLOAT
    //},
    {GL_RG32F, GL_RG, GL_FLOAT}, {GL_RG16F, GL_RG, GL_FLOAT},
    {GL_RG8UI, GL_RG_INTEGER, GL_UNSIGNED_BYTE},
    {GL_RG8I, GL_RG_INTEGER, GL_BYTE},
    {GL_RG16UI, GL_RG_INTEGER, GL_UNSIGNED_SHORT},
    {GL_RG16I, GL_RG_INTEGER, GL_SHORT},
    {GL_RG32UI, GL_RG_INTEGER, GL_UNSIGNED_INT},
    {GL_RG32I, GL_RG_INTEGER, GL_INT}, {GL_R8, GL_RED, GL_UNSIGNED_BYTE},
    {GL_R8_SNORM, GL_RED, GL_BYTE},
    // We use GL_FLOATS for this one
    //{ GL_R16F,           GL_RED,         GL_HALF_FLOAT
    //},
    {GL_R32F, GL_RED, GL_FLOAT}, {GL_R16F, GL_RED, GL_FLOAT},
    ...
    {GL_RGB16, GL_RGB, GL_UNSIGNED_SHORT}, {GL_RG16, GL_RG, GL_UNSIGNED_SHORT},
    ...
    {GL_RGB10, GL_RGBA,
     GL_UNSIGNED_INT_2_10_10_10_REV},    // RGBA instead of RGB
    ...
    {GL_RGB16_SNORM, GL_RGB, GL_SHORT}, {GL_RG16_SNORM, GL_RG, GL_SHORT},
    {GL_R16_SNORM, GL_RED, GL_SHORT},
    {GL_DEPTH_COMPONENT32, GL_DEPTH_COMPONENT, GL_UNSIGNED_INT},
    {GL_ALPHA, GL_ALPHA, GL_UNSIGNED_BYTE},

    // Cannot reliably support this. fallback to floats or ubytes...
    {GL_ALPHA4, GL_ALPHA, GL_FLOAT}, {GL_ALPHA8, GL_ALPHA, GL_UNSIGNED_BYTE},
    {GL_ALPHA12, GL_ALPHA, GL_FLOAT}, {GL_ALPHA16, GL_ALPHA, GL_UNSIGNED_SHORT},
    {GL_LUMINANCE, GL_LUMINANCE, GL_UNSIGNED_BYTE},
...
GLenum GLFormats::getBestRenderableFormat(GLenum, GLenum) {
...
bool DGLPixelTransfer::initializeOGL(GLenum internalFormat,
    ...
    GLInternalFormat* internalFormatDesr =
...
bool DGLPixelTransfer::initializeOGLES(GLenum internalFormat, GLenum implReadFormat,
                                   GLenum implReadType) {
    ...
    if (internalFormat == GL_RGB10_A2) {
        ...
        // go with implementation-dependend formats

        m_DataFormat = GLFormats::getDataFormat(implReadFormat);
        m_DataType = GLFormats::getDataType(implReadType);
    }
